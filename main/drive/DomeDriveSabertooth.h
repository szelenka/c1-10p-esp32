...
/**
  ...
  *
  */
class DomeDriveSabertooth : public DomeDrive, public SabertoothDriver
{
public:
    /** \brief Constructor
      *
      ...
      */
    DomeDriveSabertooth(int id, Stream& serial) :
        DomeDrive(),
...
protected:
    ...
    {
        DEBUG_PRINTF(
            "[DomeDriveSabertooth::motor] left: %2.6f, throttle: 0000\n",
            m
        );
