...
class DriverStation final {
 public:
   ...
   */
  static bool WaitForDsConnection(uint16_t timeout);
   ...
   *
   * @return Time remaining in current match period (auto or teleop) in milliseconds
   */
  static uint16_t GetMatchTime();
